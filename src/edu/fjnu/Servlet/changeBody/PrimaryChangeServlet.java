...
public class PrimaryChangeServlet extends HttpServlet {

    private static Logger logger = LoggerFactory.getLogger(PrimaryChangeServlet.class);
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Primaryinfo info = new Primaryinfo(userID, student.getStu_Sex(), age, height, weight, bmi, bfr, FVC, shortRun, skipRope, sitAndReach);

        try {
            Primaryinfo user = primary.queryById(userID);
            if (user == null) {
                primary.add(info);
                stu.setType(userID, "Primary");
            } else {
                primary.set(info);
                stu.setType(userID, "Primary");
            }
