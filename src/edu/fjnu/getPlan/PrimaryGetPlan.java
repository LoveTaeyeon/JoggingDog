...
public class PrimaryGetPlan {
	...
	public static void main(String[] args) {
		List<HealthPlan> planList = PrimaryGetPlan.getPlan("无常_", "坐立体前屈", "良好");
