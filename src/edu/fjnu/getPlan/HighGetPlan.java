...
public class HighGetPlan {
	...
	public static List<HealthPlan> getPlan(String userID, String forWhat,
		...
		// 算法，向用户推荐方案的算法
		List<HealthPlan> list = new ArrayList<HealthPlan>();
		HighUserPartDAO hea = new HighUserPartDAOImpl();
		HighTranslate translater = new HighTranslate();
		try {
			// 先得到用户的等级和部位适合的动作
